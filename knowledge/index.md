---
type: index
title: "oriz-roam-journal-app — knowledge bundle"
description: "App-specific knowledge for oriz-roam-journal-app. Cross-cutting family rules live at master `c:/D/oriz/knowledge/`."
tags: [okf, index, app, roam-journal]
timestamp: 2026-06-21
format_version: okf-v0.1
status: active
---

# oriz-roam-journal-app — knowledge bundle

This is the per-app OKF-light bundle for **oriz-roam-journal-app**. App-specific facts only. Cross-cutting family rules / decisions / services live at master [`../../../../knowledge/`](../../../../knowledge/).
...
- **Category**: content
- **Family role**: A privacy-first, Day-One-class PWA journal in the oriz family.
